<template>
    <div class="column is-3 list">
      ...
      <textarea v-if="editing" v-model="message" ref="message" class="textarea" rows="2"
                placeholder="New item"></textarea>
            <button v-if="editing" @click="createCard" class="button is-primary">Add</button>
